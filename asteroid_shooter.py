...
def display_score():
	...
	pygame.draw.rect(display_surface,'white',text_rect.inflate(40, 30), width = 8, border_radius = 10)
...
# ship import
ship_surf = pygame.image.load('resources/asteroid_shooter_files/project_4 - image text/graphics/ship.png').convert_alpha()
...
# background
background = pygame.image.load('resources/asteroid_shooter_files/project_4 - image text/graphics/background.png')

# laser import
laser_surf = pygame.image.load('resources/asteroid_shooter_files/project_4 - image text/graphics/laser.png').convert_alpha()
laser_list = []
...
# text import
font = pygame.font.Font('resources/asteroid_shooter_files/project_4 - image text/graphics/subatomic.ttf',50)
...
# import sound
laser_sound = pygame.mixer.Sound('resources/asteroid_shooter_files/project_15 - sound/sounds/laser.ogg')
explosion_sound = pygame.mixer.Sound('resources/asteroid_shooter_files/project_15 - sound/sounds/explosion.wav')
